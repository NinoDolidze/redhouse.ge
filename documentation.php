         ...
         <div class="container">
            <div class="row">
               <div class="col-md-12 text-center">
                  <h1 class="mt-0 mb-3 text-white">Blog Single</h1>
                  <div class="breadcrumbs">
                     <p class="mb-0 text-white"><a class="text-white" href="#">Home</a>  /  <span class="text-success">Blog Single</span></p>
                  </div>
               </div>
            </div>
         </div>
               ...
               <div class="col-lg-8 col-md-8">
                  <div class="card blog-card padding-card">
                     ...
                     <div class="card-body">
                        ...
                        <h6 class="mb-3"><i class="mdi mdi-calendar-text"></i> March 09, 2020 / 3 Comments</h6>
                        <p>
               ...
               <div class="col-lg-4 col-md-4">
                     ...
                     <div class="card-body">
                        ...
                        <div class="input-group">
                           ...
                           <div class="input-group-append">
                              <button class="btn btn-primary py-1 px-3" type="button"><i class="mdi mdi-arrow-right"></i></button>
                           </div>
                        </div>
                     </div>
                  </div>
                  <div class="card sidebar-card">
                     <div class="card-body">
                        ...
                        <p class="mb-0"><i class="mdi mdi-calendar-text"></i> April 05, 2020</p>
                        <hr>
                        <a href="#">
                           <h6>Nulla malesuada mauris non nulla imperdiet ullamcorper</h6>
                        </a>
                        <p class="mb-0"><i class="mdi mdi-calendar-text"></i> June 20, 2020</p>
                        <hr>
                        <a href="#">
                           <h6 class="text-success">Focus on creating and growing your projects and websites</h6>
                        </a>
                        <p class="mb-0"><i class="mdi mdi-calendar-text"></i> June 29, 2020</p>
                        <hr>
                        <a href="#">
                           <h6>Vestibulum lobortis urna eu mauris viverra porttitor. Cras consequat </h6>
                        </a>
                        <p class="mb-0"><i class="mdi mdi-calendar-text"></i> October 10, 2020</p>
                        <hr>
                        <a href="#">
